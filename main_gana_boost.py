...
if __name__ == '__main__':
    ...
    dataset['train_tasks'] = json.load(open(data_dir['train_tasks_woboost']))
    print("loading test_tasks ... ...")
    dataset['test_tasks'] = json.load(open(data_dir['test_tasks_woboost']))
    print("loading dev_tasks ... ...")
    dataset['dev_tasks'] = json.load(open(data_dir['dev_tasks_woboost']))
